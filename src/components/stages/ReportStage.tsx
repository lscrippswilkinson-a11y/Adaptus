    ...
    <div>
      ...
      {locked && (
        <UpgradePrompt
          ...
          body={t('Premium puts your own logo and colour on the report instead, with no mark of ours anywhere on it.')}
          cta={t('See Premium')}
      ...
      {upsell && <UpgradeModal reason={t('Reports you print or hand out carry the Adaptus mark on the free plan. Premium replaces it with your own.')} onClose={() => setUpsell(false)} />}
    </div>
  )
}
